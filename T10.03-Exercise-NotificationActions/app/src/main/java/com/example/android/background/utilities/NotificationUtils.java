...
public class NotificationUtils {
    ...
    private static final int WATER_IGNORE_PENDING_INTENT_ID = 3418;
    private static final int WATER_DRINK_PENDING_INTENT_ID = 3419;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        Intent launchWaterReminderIntentServiceIntent = new Intent(context, WaterReminderIntentService.class);
        //      TODO (7) Set the action of the intent to designate you want to dismiss the notification
        launchWaterReminderIntentServiceIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
        ...
        PendingIntent ignoreReminderPendingIntent = PendingIntent.getActivity(
                context,
                WATER_IGNORE_PENDING_INTENT_ID,
        ...
        NotificationCompat.Action aciton = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,
                "No, thanks.",
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent drinkWaterPendingIntent = PendingIntent.getActivity(
                context,
                WATER_DRINK_PENDING_INTENT_ID,
                launchWaterReminderIntentServiceIntent,
                PendingIntent.FLAG_CANCEL_CURRENT
        );
        //      TODO (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action aciton = new NotificationCompat.Action(R.drawable.ic_local_drink_black_24px,
                "I did it!",
