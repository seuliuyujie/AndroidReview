...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        sharedPreferences.registerOnSharedPreferenceChangeListener(VisualizerActivity.this);
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        PreferenceManager.getDefaultSharedPreferences(VisualizerActivity.this).unregisterOnSharedPreferenceChangeListener(VisualizerActivity.this);
    }
