...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCharingFilter = new IntentFilter();
        mCharingFilter.addAction(Intent.ACTION_POWER_CONNECTED);
        mCharingFilter.addAction(Intent.ACTION_POWER_DISCONNECTED);
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mChargingBroadcastReceiver,mCharingFilter);
    }
    ...
    public void showCharging(boolean isCharing) {
        if (isCharing)
